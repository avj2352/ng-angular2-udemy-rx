...
# Angular + RxJS + Redux = NgRx Store !!

Next, we will be installing the `@ngrx/store` library. This is very similar to the Redux library but is compatible with RxJS
...
```js
{
  ...
  "scripts": {
    ...
    "api-server:debug": "./node_modules/.bin/ts-node $NODE_DEBUG_OPTION ./src/server/server.ts"
  },
  "private": true,
  "dependencies": {
    ...
    "@ngrx/store": "^2.2.3", // FIXME: This is the new library for Redux and RxJS
